...
const HistoryBar = ({
  ...
  return (
    <div className="w-60 sm:w-60 md:w-64 lg:w-72 min-h-screen border-r-3 border-t-3 rounded-tr-lg overflow-hidden inline-block bg-white dark:bg-zinc-800 text-black  dark:text-white">
